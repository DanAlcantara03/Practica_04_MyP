...
/**
 * Clase especifica que nos modela un Sistema de Propulsion Intergalactico por
 * defecto, aqui ya implementaremos todos los metodos de la interfaz ComponenteNave
 */
public class IntergalacticoPD extends SDPIntergalactico{
    
    /* Constructor vacio. */
    public IntergalacticoPD(){}
    ...
    @Override public String descripcion(){
        return "Viaja largas distancias entre galaxias";
    }
